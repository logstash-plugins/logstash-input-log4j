...
Next, {filebeat-ref}/filebeat-installation-configuration.html[install filebeat]. Based on the
...
{logstash-ref}/plugins-inputs-beats.html[the logstash beats input documentation].
